  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start space-x-6">
        <img
          src={hotel.mainImage || 'https://images.pexels.com/photos/258154/pexels-photo-258154.jpeg'}
          alt={hotel.name}
      ...
      {hotel.relatedLocations && hotel.relatedLocations.length > 0 && (
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {hotel.relatedLocations.map((location, index) => (
              <span
                key={index}
